      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" href="cajero.html">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="registrocli.html">
            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image"> <img src="imágenes/cliente.jpeg" width="500" height="600"></div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4">Redaccion de Reporte</h4>
                            </div>
                            <form class="user" action="newReport.php" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleInputID" placeholder="Id del empleado que reporta" name="id"></div>
                                </div>
                                <div class="form-group"><textarea id="body" name="body" rows="10" cols="50"></textarea></div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleDateInput" placeholder="Fecha" name="fecha"></div>
                                </div><button class="btn btn-primary btn-block text-white btn-user" type="submit">Guardar reporte</button>
                                <hr>
                            </form>
                        </div>
                    </div>
